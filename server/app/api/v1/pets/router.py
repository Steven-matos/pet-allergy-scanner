...
async def create_pet(
    ...
    try:
        ...
        return PetResponse(
            ...
            birthday=created_pet["birthday"],
            weight_kg=created_pet["weight_kg"],
            activity_level=created_pet["activity_level"],
            image_url=created_pet["image_url"],
            known_sensitivities=created_pet["known_sensitivities"],
            vet_name=created_pet["vet_name"],
            vet_phone=created_pet["vet_phone"],
